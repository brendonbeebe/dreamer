...
(function() {
    ...
    AbstractChosen = (function() {
        ...
        AbstractChosen.prototype.set_default_values = function() {
            ...
            this.delete_option = this.options.delete_option || false;
...
(function() {
    ...
    Chosen = (function(_super) {
        ...
        Chosen.prototype.select_delete_option = function(){
            var currentlyHighlighted = Chosen.prototype.currentHover;
            if ($.isFunction(this.delete_option)) {
                Chosen.prototype.currentHover.remove();
                return this.delete_option.call(this,currentlyHighlighted.text());
            } else {
                Chosen.prototype.currentHover.remove();
            }
        };
