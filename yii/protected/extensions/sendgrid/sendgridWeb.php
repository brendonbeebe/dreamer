 ...
 * Based on Alon Ben David's SendGrid PHP API
...
Yii::import("ext.sendgrid.sendgridConnect");
class sendgridWeb extends sendgridConnect {
	...
	*/
    ...
    public function mail_send_short( $to , $toname = '' , $subject , $html ) {
        $url = "mail.send";
